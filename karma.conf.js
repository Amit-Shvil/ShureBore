...
module.exports = function (config) {
  config.set({
    ...
    ngHtml2JsPreprocessor: {
      stripPrefix: '(app|.tmp)/',
      moduleName: 'documentsAppInternal'
    },
    ...
    files: [
      ...
      'app/bower_components/wix-style/dist/scripts/locale/messages_en.js',
      'app/bower_components/wix-style/dist/scripts/scripts.js',
      '{app,.tmp}/*.js',
      '{app,.tmp}/scripts/*.js',
      '{app,.tmp}/scripts/*/**/*.js',
      '{,.tmp/}test/**/*.js',
