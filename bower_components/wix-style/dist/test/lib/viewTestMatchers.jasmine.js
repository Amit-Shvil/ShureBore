    ...
    beforeEach(function () {
        ...
        var toBeDisabled = function (util, customEqualityTesters) {
            return {
                compare: function (actual, expected) {
                    var element = actual;
                    var passed = element.length > 0 && element.attr('disabled');
                    return {
                        pass: passed
                    };
                }
        ...
        var toHaveClass = function (util, customEqualityTesters) {
            return {
                compare: function (actual, expected) {
                    var passed = actual.hasClass ? actual.hasClass(expected) : angular.element(actual).hasClass(expected);
                    return {
                        pass: passed,
...
//# sourceMappingURL=viewTestMatchers.jasmine.js.map