# Wix Angular Components Test Kit
...
|---|---|---|---|
|byDataHook|global method|dataHook: string|Create a data-hook selector it is useful for methods that uses selectors such as ***WixBaseViewUnitDriver.defineChild***|
